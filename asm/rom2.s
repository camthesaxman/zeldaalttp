	...
	THUMB_FUNC_START sub_0800BE50
sub_0800BE50: @ 0x0800BE50
	push {r4,r5,lr}
...
_0800BEC0:
	...
	THUMB_FUNC_END sub_0800BE50

	THUMB_FUNC_START sub_0800BEC4
sub_0800BEC4: @ 0x0800BEC4
	push {lr}
...
_0800BED4:
	.4byte gUnknown_0202A8D0
	THUMB_FUNC_END sub_0800BEC4

	THUMB_FUNC_START sub_0800BED8
sub_0800BED8: @ 0x0800BED8
	push {r4-r7,lr}
	mov r7, r8
	push {r7}
	sub sp, sp, #16
	...
	mov r7, #0
	strh r7, [r0]
	ldr r0, _0800BF78  @ =gUnknown_0300050C
	strb r7, [r0]
	ldr r0, _0800BF7C  @ =gUnknown_03000204
	strb r7, [r0]
	ldr r0, _0800BF80  @ =gUnknown_03000E34
	ldr r6, _0800BF84  @ =gUnknown_03006630
	str r6, [r0]
	ldr r1, _0800BF88  @ =gUnknown_03005E08
	add r0, r6, #0
	add r0, r0, #128
	str r0, [r1]
	ldr r0, _0800BF8C  @ =gUnknown_03005E04
	ldr r4, _0800BF90  @ =gUnknown_03005E60
	str r4, [r0]
	ldr r0, _0800BF94  @ =gUnknown_03000948
	mov r1, #0
	mov r8, r1
	strb r7, [r0, #5]
	strb r7, [r0, #4]
	...
	mov r1, #224
	lsl r1, r1, #19
	ldr r2, _0800BF98  @ =0x01000100
	mov r0, sp
	bl CpuFastSet
	str r5, [sp, #4]
	add r0, sp, #4
	sub r4, r4, #64
	ldr r2, _0800BF9C  @ =0x01000200
	add r1, r4, #0
	bl CpuFastSet
	mov r0, r8
	str r0, [sp, #8]
	add r0, sp, #8
	ldr r2, _0800BFA0  @ =0x01000040
	add r1, r6, #0
	bl CpuFastSet
	mov r1, r8
	str r1, [sp, #12]
	...
	cmp r0, #0
	beq _0800BF6A
	ldr r1, _0800BFB0  @ =0x040000B0
	ldrh r2, [r1, #10]
	ldr r0, _0800BFB4  @ =0x0000C5FF
	and r0, r0, r2
	strh r0, [r1, #10]
	ldrh r2, [r1, #10]
	ldr r0, _0800BFB8  @ =0x00007FFF
	and r0, r0, r2
	strh r0, [r1, #10]
	ldrh r0, [r1, #10]
	strb r7, [r3]
...
_0800BFB8:
	.4byte 0x00007FFF
	THUMB_FUNC_END sub_0800BED8

	THUMB_FUNC_START sub_0800BFBC
sub_0800BFBC: @ 0x0800BFBC
	push {r4,lr}
...
_0800BFD4:
	...
	THUMB_FUNC_END sub_0800BFBC

	THUMB_FUNC_START sub_0800BFD8
sub_0800BFD8: @ 0x0800BFD8
	add r2, r0, #0
	mov r3, #0
	mov r0, #253
	lsl r0, r0, #24
	add r1, r2, r0
	ldr r0, _0800BFFC  @ =0x00007FFF
	cmp r1, r0
	bls _0800BFF4
	mov r0, #254
	lsl r0, r0, #24
	add r1, r2, r0
	ldr r0, _0800C000  @ =0x0003FFFF
	cmp r1, r0
	bhi _0800BFF6
_0800BFF4:
	mov r3, #1
...
sub_0800C024: @ 0x0800C024
	mov r2, #0
	mov r1, #248
	lsl r1, r1, #24
	add r0, r0, r1
	ldr r1, _0800C038  @ =0x007FFFFF
	cmp r0, r1
	bhi _0800C034
	mov r2, #1
_0800C034:
...
_0800C038:
	.4byte 0x007FFFFF
	THUMB_FUNC_END sub_0800C024

	THUMB_FUNC_START sub_0800C03C
sub_0800C03C: @ 0x0800C03C
	push {r4,lr}
...
_0800C05C:
	...
	THUMB_FUNC_END sub_0800C03C

	THUMB_FUNC_START sub_0800C060
sub_0800C060: @ 0x0800C060
	push {r4,lr}
...
_0800C07C:
	...
	THUMB_FUNC_START sub_0800C080
sub_0800C080: @ 0x0800C080
	ldr r0, _0800C098  @ =gUnknown_03000520
	ldrb r1, [r0, #4]
	cmp r1, #0
	beq _0800C0A4
	ldr r1, _0800C09C  @ =gUnknown_0200B310
	mov r0, #1
	neg r0, r0
	str r0, [r1]
	ldr r1, _0800C0A0  @ =gUnknown_0201EDE0
	mov r0, #0
	str r0, [r1]
	b _0800C0AA
_0800C098:
...
_0800C0A4:
	ldr r0, _0800C0AC  @ =gUnknown_030004A0
	add r0, r0, #102
	strh r1, [r0]
_0800C0AA:
	bx lr
_0800C0AC:
	...
	THUMB_FUNC_END sub_0800C080

	THUMB_FUNC_START sub_0800C0B0
sub_0800C0B0: @ 0x0800C0B0
	push {r4,r5,lr}
	lsl r0, r0, #24
	lsr r3, r0, #24
	ldr r2, _0800C0E0  @ =gUnknown_03000520
	mov r5, #0
	strb r3, [r2, #1]
	strb r1, [r2, #3]
	mov r4, #1
...
_0800C0D8:
	strb r0, [r2, #7]
	ldr r0, _0800C0E4  @ =gUnknown_0200B310
	str r5, [r0]
	b _0800C10A
_0800C0E0:
	.4byte gUnknown_03000520
_0800C0E4:
	.4byte gUnknown_0200B310
_0800C0E8:
	ldr r2, _0800C110  @ =gUnknown_030004A0
	ldr r1, _0800C114  @ =gUnknown_08137D18
	lsl r0, r3, #1
	add r0, r0, r1
	ldrh r0, [r0]
	add r1, r2, #0
...
_0800C110:
	.4byte gUnknown_030004A0
_0800C114:
	.4byte gUnknown_08137D18
	THUMB_FUNC_END sub_0800C0B0

	THUMB_FUNC_START sub_0800C118
sub_0800C118: @ 0x0800C118
	push {lr}
	ldr r2, _0800C138  @ =gUnknown_03000520
	ldrb r0, [r2]
	cmp r0, #0
	beq _0800C132
	ldr r0, _0800C13C  @ =gUnknown_08427390
	ldrb r1, [r2, #1]
	lsl r1, r1, #2
	add r1, r1, r0
	ldr r1, [r1]
...
_0800C138:
	.4byte gUnknown_03000520
_0800C13C:
	.4byte gUnknown_08427390
	THUMB_FUNC_END sub_0800C118

	THUMB_FUNC_START sub_0800C140
sub_0800C140: @ 0x0800C140
	push {r4,lr}
	add r3, r0, #0
	ldrb r4, [r3, #4]
	cmp r4, #0
...
_0800C168:
	...
	sub r0, r0, r1
	strh r0, [r3, #8]
	ldr r2, _0800C18C  @ =gUnknown_030004A0
	lsl r0, r0, #16
	asr r1, r0, #20
	add r2, r2, #106
	strh r1, [r2]
...
_0800C18C:
	.4byte gUnknown_030004A0
	THUMB_FUNC_END sub_0800C140

	THUMB_FUNC_START sub_0800C190
sub_0800C190: @ 0x0800C190
	push {r4,lr}
	add r4, r0, #0
	ldrb r0, [r4, #4]
	cmp r0, #0
...
_0800C1BE:
	...
	sub r1, r1, r0
	strh r1, [r4, #8]
	ldr r3, _0800C1E8  @ =gUnknown_030004A0
	lsl r1, r1, #16
	asr r2, r1, #20
	mov r0, #16
	sub r0, r0, r2
