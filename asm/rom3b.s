...
sub_080C382C: @ 0x080C382C
	...
	lsl r0, r0, #24
	lsr r1, r0, #24
	ldr r0, _080C3844  @ =gUnknown_02002320
	ldrb r0, [r0]
	cmp r0, #0
	bne _080C3850
	cmp r1, #225
...
sub_080C3AC8: @ 0x080C3AC8
	...
	cmp r0, #13
	bne _080C3AEC
	ldr r0, _080C3BAC  @ =gUnknown_0200233D
	ldrb r0, [r0]
	cmp r0, #3
	bls _080C3B2A
_080C3AEC:
...
sub_080C3BD0: @ 0x080C3BD0
	...
	ldr r2, _080C3C7C  @ =gUnknown_0200233F
...
sub_080C4080: @ 0x080C4080
	...
	ldrb r1, [r2]
	strb r1, [r0]
	ldr r0, _080C40E0  @ =gUnknown_0200233D
	ldrb r0, [r0]
	sub r0, r0, #1
	lsl r0, r0, #24
	lsr r3, r0, #24
...
_080C4814:
	...
	cmp r0, #0
	beq _080C4912
	ldr r0, _080C48A4  @ =gUnknown_0200233E
	ldrb r0, [r0]
	cmp r0, #0
	beq _080C4912
...
sub_080C4EC4: @ 0x080C4EC4
	...
	cmp r0, #6
	bne _080C4EE0
	ldr r0, _080C4EE8  @ =gUnknown_02002320
	ldrb r0, [r0]
	cmp r0, #2
	bhi _080C4EEC
_080C4EE0:
...
sub_080C99F8: @ 0x080C99F8
	push {lr}
	ldr r0, _080C9A08  @ =gUnknown_02002325
	ldrb r0, [r0]
	cmp r0, #2
	bne _080C9A0C
	mov r0, #0
...
_080C9A0C:
	ldr r0, _080C9A18  @ =gUnknown_0200232B
	ldrb r0, [r0]
	cmp r0, #2
	bne _080C9A1C
	mov r0, #1
...
_080C9A1C:
	ldr r0, _080C9A28  @ =gUnknown_02002331
	ldrb r0, [r0]
	cmp r0, #2
	bne _080C9A2C
	mov r0, #2
...
_080C9A2C:
	ldr r0, _080C9A3C  @ =gUnknown_02002337
	ldrb r0, [r0]
	cmp r0, #2
	beq _080C9A40
	mov r0, #1
