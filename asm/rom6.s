...
sub_08135BCC: @ 0x08135BCC
	...
	cmp r0, #4
	bne _08135BE8
	ldr r1, _08135BE0  @ =gUnknown_03000020
	ldr r0, _08135BE4  @ =gUnknown_084272A4
	str r0, [r1]
	b _08135C04
_08135BE0:
	.4byte gUnknown_03000020
_08135BE4:
	.4byte gUnknown_084272A4
_08135BE8:
	cmp r0, #64
	bne _08135BFC
	ldr r1, _08135BF4  @ =gUnknown_03000020
	ldr r0, _08135BF8  @ =gUnknown_084272B0
	str r0, [r1]
	b _08135C04
_08135BF4:
	.4byte gUnknown_03000020
_08135BF8:
	.4byte gUnknown_084272B0
_08135BFC:
	ldr r1, _08135C0C  @ =gUnknown_03000020
	ldr r0, _08135C10  @ =gUnknown_084272A4
	str r0, [r1]
	mov r2, #1
_08135C04:
	add r0, r2, #0
...
sub_08135C14: @ 0x08135C14
	push {lr}
	ldr r1, _08135C34  @ =gUnknown_03000012
	ldrh r0, [r1]
	cmp r0, #0
	beq _08135C30
	ldrh r0, [r1]
	...
	cmp r0, #0
	bne _08135C30
	ldr r1, _08135C38  @ =gUnknown_03000014
	mov r0, #1
	strb r0, [r1]
_08135C30:
	pop {r0}
	bx r0
_08135C34:
	.4byte gUnknown_03000012
_08135C38:
	.4byte gUnknown_03000014
...
sub_08135C3C: @ 0x08135C3C
	...
	cmp r1, #3
	bhi _08135C70
	ldr r0, _08135C60  @ =gUnknown_03000010
	strb r1, [r0]
	ldr r1, _08135C64  @ =gUnknown_03000018
	ldrb r0, [r0]
	lsl r0, r0, #2
	...
	b _08135C72
_08135C60:
	.4byte gUnknown_03000010
_08135C64:
	.4byte gUnknown_03000018
_08135C68:
	.4byte 0x04000100
_08135C6C:
	.4byte 0x08135C15
...
sub_08135C78: @ 0x08135C78
	...
	mov r6, r8
	push {r6,r7}
	ldr r2, _08135CE4  @ =gUnknown_0300001C
	...
	mov r2, r9
	strh r6, [r2]
	ldr r3, _08135CEC  @ =gUnknown_03000018
	mov r8, r3
	ldr r5, [r3]
	strh r6, [r5, #2]
	ldr r3, _08135CF0  @ =0x04000202
	ldr r4, _08135CF4  @ =gUnknown_03000010
	ldrb r1, [r4]
	mov r2, #8
	add r7, r2, #0
	lsl r7, r7, r1
	...
	orr r1, r1, r2
	strh r1, [r3]
	ldr r1, _08135CF8  @ =gUnknown_03000014
	strb r6, [r1]
	ldr r2, _08135CFC  @ =gUnknown_03000012
	ldrh r1, [r0]
	strh r1, [r2]
	add r0, r0, #2
	ldrh r1, [r0]
...
sub_08135D00: @ 0x08135D00
	...
	mov r1, #0
	strh r1, [r3]
	ldr r2, _08135D34  @ =gUnknown_03000018
	ldr r0, [r2]
	strh r1, [r0]
	add r0, r0, #2
	str r0, [r2]
	...
	ldr r0, _08135D3C  @ =gUnknown_03000010
	ldrb r0, [r0]
	mov r1, #8
	lsl r1, r1, r0
	ldrh r0, [r2]
	bic r0, r0, r1
	strh r0, [r2]
	ldr r0, _08135D40  @ =gUnknown_0300001C
	ldrh r0, [r0]
	strh r0, [r3]
	bx lr
	.byte 0x00
...
sub_08135D44: @ 0x08135D44
	...
	and r4, r4, r3
	ldr r3, _08135DB0  @ =gUnknown_03000020
	ldr r3, [r3]
	ldrh r3, [r3, #6]
	orr r4, r4, r3
	strh r4, [r5]
...
sub_08135DC4: @ 0x08135DC4
	...
	lsl r0, r0, #16
	lsr r3, r0, #16
	ldr r0, _08135DDC  @ =gUnknown_03000020
	ldr r0, [r0]
	ldrh r0, [r0, #4]
	cmp r3, r0
	bcc _08135DE4
...
_08135DE0:
	.4byte 0x000080FF
_08135DE4:
	ldr r0, _08135E70  @ =gUnknown_03000020
	add r6, r0, #0
	ldr r0, [r0]
	ldrb r1, [r0, #8]
	lsl r0, r1, #1
...
sub_08135E74: @ 0x08135E74
	...
	lsl r0, r0, #16
	lsr r4, r0, #16
	ldr r0, _08135E8C  @ =gUnknown_03000020
	ldr r0, [r0]
	ldrh r0, [r0, #4]
	cmp r4, r0
	bcc _08135E94
...
_08135E90:
	.4byte 0x000080FF
_08135E94:
	ldr r0, _08135ED4  @ =gUnknown_03000020
	ldr r0, [r0]
	ldrb r0, [r0, #8]
	lsl r0, r0, #1
	mov r1, sp
...
_08135EE6:
	...
	mov r1, #208
	lsl r1, r1, #20
	ldr r0, _08135F40  @ =gUnknown_03000020
	ldr r0, [r0]
	ldrb r2, [r0, #8]
	add r2, r2, #67
	mov r0, sp
	bl sub_08135D44
	ldr r0, _08135F44  @ =gUnknown_084272BC
	bl sub_08135C78
	mov r4, #0
	mov r1, #208
	lsl r1, r1, #20
	mov r3, #1
	ldr r2, _08135F48  @ =gUnknown_03000014
_08135F18:
	ldrh r0, [r1]
	and r0, r0, r3
	cmp r0, #0
...
sub_08135F50: @ 0x08135F50
	...
	lsr r1, r0, #16
	mov r5, #0
	ldr r0, _08135F6C  @ =gUnknown_03000020
	ldr r0, [r0]
	ldrh r0, [r0, #4]
	cmp r1, r0
	bcc _08135F74
